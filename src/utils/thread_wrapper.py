...
class HL_Thread:
    ...
    def start(self):
        ...
        self.thread.__setattr__(HL_Thread.keep_alive_word, True)
        self.thread.start()

    def is_alive(self):
        return getattr(self.thread, HL_Thread.keep_alive_word, True)

    def shutdown(self):
        self.thread.__setattr__(HL_Thread.keep_alive_word, False)

    def get_name(self):
        return self.thread.name

    def __str__(self):
        stra = "<Motion Thread>:"+self.get_name()
        return stra