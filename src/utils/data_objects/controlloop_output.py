...
class ControlLoopOutput(OutputSuperclass):
    ...
    def print_stats(self):
        ...
        print("       nb configs:\t\t", len(self.configs))
        print("       end stance idx:\t", self.end_stance_idx)
        print("       nb stances:\t\t", self.nb_stances)
        print("       dist to end:\t\t", round(self.dist_to_end, 4))
        print("       total dist:\t\t", round(self.dist_from_start_to_end, 4))
        print()
