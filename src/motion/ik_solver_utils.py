...
class IKSolverUtils(MotionUtils):
    ...
    def __init__(self, ProjectConstants, world, height_map,scatter_list, state_path, gradient_map):
        MotionUtils.__init__(self, ProjectConstants, world, height_map, scatter_list, state_path, gradient_map)
    ...
    def set_pose(self, r_pose):
        ...
        s.setBiasConfig(self.ProjectConstants.NOMINAL_CONFIG)
        res = s.solve()
        if not res:
